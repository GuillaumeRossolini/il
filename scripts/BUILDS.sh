...
cd /usr/local/src/php-$TMPV_PHP56/ext/xdebug && sh /usr/local/php56/bin/phpize && ./configure --with-php-config=/usr/local/php56/bin/php-config && make && make install && cd /usr/local/src/php-$TMPV_PHP56 && \
...
cd /usr/local/src/php-$TMPV_PHP70/ext/xdebug && sh /usr/local/php70/bin/phpize && ./configure --with-php-config=/usr/local/php70/bin/php-config && make && make install && cd /usr/local/src/php-$TMPV_PHP70 && \
...
cd /usr/local/src/php-$TMPV_PHP71/ext/xdebug && sh /usr/local/php71/bin/phpize && ./configure --with-php-config=/usr/local/php71/bin/php-config && make && make install && cd /usr/local/src/php-$TMPV_PHP71 && \
...
cd /usr/local/src/php-$TMPV_PHP72/ext/xdebug && sh /usr/local/php72/bin/phpize && ./configure --with-php-config=/usr/local/php72/bin/php-config && make && make install && cd /usr/local/src/php-$TMPV_PHP72 && \
...
cd /usr/local/src/php-$TMPV_PHP73/ext/xdebug && sh /usr/local/php73/bin/phpize && ./configure --with-php-config=/usr/local/php73/bin/php-config && make && make install && cd /usr/local/src/php-$TMPV_PHP73 && \
